...
const Home = () => {
  ...
  return (
    <section id="Home" data-aos="fade-up" className="section1 flex md:flex-row flex-col gap-10 p-10 md:pt-32 pt-16  items-center md:max-h-screen md:h-screen">
      ...
      <div className="container_right flex text-white flex-col md:w-1/2 gap-3 ">
        ...
        <div  className="icon md:mt-14 mt-8">
          <ul className="flex flex-row gap-x-5">
            ...
            <li className="ico cursor-pointer ease-in-out duration-400 hover:-translate-y-1 hover:scale-110 ring-2 rounded-full p-2 text-red-700 ring-red-700 hover:ring-white hover:text-white hover:shadow-md hover:shadow-white  ">
              <SiCodesandbox className=" md:text-xl " />
            </li>
            <li className="ico cursor-pointer ease-in-out duration-400 hover:-translate-y-1 hover:scale-110 ring-2 rounded-full p-2 text-red-700 ring-red-700 hover:ring-white hover:text-white hover:shadow-md hover:shadow-white  ">
